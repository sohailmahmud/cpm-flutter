    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: <BoxShadow>[
                                BoxShadow(color: kBackgroundColor.withOpacity(0.6), offset: const Offset(2.0, 4.0), blurRadius: 8),
                              ],
                            ),
                            child: ClipRRect(
          ...
          Divider(
            height: 1,
            color: kBaseColor.withOpacity(0.6),
          ),
          Expanded(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                    ...
                    width: 24,
                    height: 24,
                    child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.blue : kBaseColor),
                  )
                      : Icon(listData.icon.icon, color: widget.screenIndex == listData.index ? Colors.blue : kBaseColor),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.blue : kBaseColor,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
