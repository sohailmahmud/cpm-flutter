...
class EarningsState extends State<Earnings> {
  ...
  static final List<String> chartDropdownItems = [ 'Last 7 days earnings', 'Last month earnings', 'Last year earnings' ];
          ...
          actions: <Widget>[
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text('Earning History', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
